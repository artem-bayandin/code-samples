...
{
    public class GetUserAnswersForQuizQueryValidator : AbstractValidator<GetUserAnswersForQuizQuery>
    {
        private readonly IQuizPortOut _quizPortOut;
        private readonly IUserPortOut _userPortOut;

        public GetUserAnswersForQuizQueryValidator(IQuizPortOut quizPortOut, IUserPortOut userPortOut)
        {
